...
#test badge
parlspeech_uk <- parlspeech_uk[50001:500000,] #change manually depending on what badge you want to run
...
#write to file 
saveRDS(parlspeech_uk_sentences, "data/uk_parliament/uk_parlspeechv2/parlspeech_uk_sentences_500k.rds")
